...
const HeroTemplate = ({pageName="",title="",description=""}: {pageName: string,title: string,description: string}) => {
  return (
    <div className='lg:h-[40vh] h-[28vh] bg-gradient-to-r from-[#0F0F0F] via-[#0F0F0F] to-[#222222] flex flex-col justify-center items-center gap-5'>
      ...
      <div className='flex flex-col gap-4 text-center'>
        ...
        <h6 className='lg:text-base text-sm opacity-80 font-normal'>{description}</h6>
      </div>
    </div>
  )
}
