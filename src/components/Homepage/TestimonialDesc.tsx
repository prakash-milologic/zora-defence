...
const TestimonialDesc = () => {
  return (
    <div className="swiper-slide group bg-[#171717] rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6">
    <h6 className="text-base opacity-80 font-normal">
    We hired Zora Defence for our corporate event, and their team went above and beyond to ensure everything ran smoothly. The security personnel were professional, courteous, and clearly well-trained. Their presence was reassuring, and they handled every situation with confidence and efficiency.
        ...
        <div className="flex items-center gap-5 mb-5 sm:mb-9">
            <Image className="w-20 h-20 rounded-full object-cover" src={testimonial} alt="avatar" />
            <div className="grid gap-1">
                <h5 className="text-xl font-bold">Sandor Clegane</h5>
                <h6 className="text-base opacity-80 font-normal">
                Co-Founder - Digg Inc.</h6>
            </div>
        </div>
